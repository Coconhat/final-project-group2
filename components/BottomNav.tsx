  ...
  return (
    ...
    >
      <View className="flex-row justify-around items-center pt-3 pb-2 px-4 rounded-t-[3rem]">
        <TouchableOpacity className="items-center justify-center bg-[#fd8863]/20 rounded-full px-5 py-2">
          <MaterialIcons name="pets" size={24} color="#a04223" />
          <Text className="text-[#a04223] text-xs font-medium font-body mt-1">
            Explore
          </Text>
        </TouchableOpacity>
        <TouchableOpacity className="items-center justify-center px-5 py-2">
          <MaterialIcons
